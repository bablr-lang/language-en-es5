 ...
 * @generatedfrom ./grammar.macro.js#993a796af59d62223da7447cf07d5511b18ae0a9
...
export const atrivialGrammar = class ES5Grammar extends (_es3$atrivialGrammar = es3.atrivialGrammar) {
  ...
  *[(_FunctionExpressionDecs = [CoveredBy('Expression'), Node], _ObjectDecs = [CoveredBy('JSONExpression'), CoveredBy('Expression'), Node], "Expression")]({
    props: {
      power = 34
    },
    s
